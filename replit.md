...
- June 30, 2025. Replaced clickable age range selection cards with dual-handle slider that skips 4 years per tick (18-22, 22-26, 26-30, etc.) for more intuitive age range selection. Slider ranges from 18 to 78 years with smooth interaction for creating custom age preferences. Updated age validation to support full adult age range (18+) instead of previous 18-25 limit.
